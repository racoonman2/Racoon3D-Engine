...
import racoonman.r3d.render.api.objects.ResizableSwapchain;
...
public class Window implements IWindow {
	...
	public Window(int w, int h, CharSequence title, PresentMode presentMode) {
		this(w, h, title, null, null, presentMode);
	}

	public Window(int w, int h, CharSequence title, Monitor monitor, Window share, PresentMode presentMode) {
