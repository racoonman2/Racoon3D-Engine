...
public enum Format implements IVkType {
	...
	public static final ICodec<Format> ORDINAL_CODEC = EnumCodec.byOrdinal(values());
	public static final ICodec<Format> NAME_CODEC = EnumCodec.byName(Format::valueOf);
	
	private int vkType;
	
	private Format(int vkType) {
		this.vkType = vkType;
	}
