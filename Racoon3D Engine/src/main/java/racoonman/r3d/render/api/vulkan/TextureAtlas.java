...
//
////TODO rewrite
//public class TextureAtlas implements ITexture {
//	private Device device;
//	private int width;
//	private int height;
//	private int mipLevels;
//	private PipelineStage dstStage;
//	private Image image;
//	private ImageView view;
//	private Map<String, NativeImage> images;
//	private Map<String, Frame> frames;
//	private TextureState state;
//	
//	public TextureAtlas(Format format, PipelineStage stage, Map<String, NativeImage> images) {
...
//			
//			int x = 0;
//			for(Entry<String, NativeImage> entry : this.images.entrySet()) {
//				String name = entry.getKey();
//				NativeImage image = entry.getValue();
//				this.recordBufferCopy(x, image, stack, cmd, ITexture.makeStageBuffer(image.getData()));
//				
//				this.frames.put(name, new Frame((float) (x) / this.width, 0.0F, (float) (x + image.getWidth()) / this.width, 1.0F));
//				
//				x += image.getWidth();
//			}
//			
...
//			dstStage = this.dstStage.getVkType();
...
//	}
//
//	private void recordBufferCopy(int x, NativeImage img, MemoryStack stack, CommandBuffer cmd, IDeviceBuffer bufferData) {
...
//    			.layerCount(1)
//    		 )
//    		.imageOffset(it -> it.x(x).y(0).z(0))
//    		.imageExtent(it -> it.width(img.getWidth()).height(img.getHeight()).depth(1)));
//    }
//	
...
//			
//			vkCmdPipelineBarrier(vkCmdBuf,
//                    VK_PIPELINE_STAGE_TRANSFER_BIT, this.dstStage.getVkType(), 0,
//                    null, null, barrier);
//			
//			if(mipWidth > 1) {
//				mipWidth /= 2;
...
//	}
//	
//	public record Frame(float u0, float v0, float u1, float v1) {
//	}
//}
